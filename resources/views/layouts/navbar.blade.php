<header
    x-data='{ isSidebarOpen: false, isBagOpen: false, isSearchOpen: false, isDropdownOpen: false }'
>
    {{-- Navbar --}}
        ...
        <div class='flex items-center gap-2.5 text-gray-900'>
            ...
            <div class="flex items-center">
                <div class='relative hidden sm:block'>
                    ...
                    >
                        <div
                            class='py-1 bg-white ring-1 ring-black ring-opacity-5'>
                            <ul>
                                <li
            ...
            <div class='relative'>
                ...
                <div
                    x-show='isSearchOpen'
                    x-on:mouseout='isSearchOpen = false'
                    x-transition:enter='transition ease-out duration-200'
                    x-transition:enter-start='transform opacity-0 scale-95'
                    x-transition:enter-end='transform opacity-100 scale-100'
                    x-transition:leave='transition ease-in duration-75'
            ...
            <div class='relative'>
                <div
                    @click='isDropdownOpen = false; isSidebarOpen = false; isBagOpen = true; isSearchOpen = false;'>
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        class="w-6 h-6"
                        fill="none"
