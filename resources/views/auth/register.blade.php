    ...
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                ...
                <x-input id="cpf" class="block w-full mt-1" type="text" name="cpf" :value="old('cpf')" maxlength="11" required />
            </div>
            ...
            <div class="mt-4">
				...
				<x-input id="telephone" class="block w-full mt-1" type="text" name="telephone" :value="old('telephone')" maxlength="11" required />
			</div>
