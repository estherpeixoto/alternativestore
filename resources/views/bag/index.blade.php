                            ...
                            <div class="flex flex-col w-full">
                                ...
                                <div class="flex flex-col justify-between gap-3 mt-3 md:flex-row lg:mt-6">
                                    ...
                                    <div class="flex border border-gray-300 rounded-md w-min">
                                        <button data-type="quantity" onclick="decrease(event, {{ $product->id }})"
                                        ...
                                        <input id="quantity{{ $product->id }}"
                                            class="items-center w-10 px-3 py-1 text-xs font-semibold text-center text-gray-500"
                                            value="{{ $product->quantity }}" />

                                        <button data-type="quantity" onclick="increase(event, {{ $product->id }})"
